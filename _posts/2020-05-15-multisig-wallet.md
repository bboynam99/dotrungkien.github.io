...
- Multisig Wallet có thể dùng để giải quyết tranh chấp. Một ví dụ là A và B mua bán tài sản, họ quyết định làm một multisig wallet 2-of-3 với sự tham gia của 3 bên A, B, và bên thẩm định C. Trong trường hợp A và B đã ký đồng thuận _đồng ý_ hoặc _huỷ bỏ_, thì sẽ không cần đến sự tham gia của C. Ngược lại nếu chỉ một người ký _đồng ký_, còn người còn lại ký _huỷ bỏ_, thì chữ ký của C sẽ quyết định xem giao dịch sẽ được _đồng ý_ hay _huỷ bỏ_ theo số đông 2 trên 3 quyết định.
...
- Cả blockchain và multisig vẫn là những công nghệ còn mới, việc audit và đảm bảo security vẫn còn hạn chế. Không có gì có thể đảm bảo 100% những gì hoạt động hôm nay sẽ không bị hack vào ngày mai. Ví dụ [vụ hack 300 triệu đô](https://medium.com/chain-cloud-company-blog/parity-multisig-hack-again-b46771eaa838) của Parity Wallet chẳng hạn.
...
Trong ví dụ này, transaction chỉ được diễn ra khi tất cả các owner đều đồng thuận.
