...
Kiến thức về đường cong elliptic nói chung khá là rộng, nên trong khuôn khổ bài này chúng ta sẽ chỉ đi vào một đường cong cụ thể được sử dụng trong Bitcoin và Ethereum mà thôi.
...
Để tính được `s`, đầu tiên ta tính _hash của message_ mà ta cần ký, gọi là `z`, khi này:
